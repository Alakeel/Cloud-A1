...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Sign Up &middot; InstaCloud</title>
  ...
  <body>
	...
	<?php include '../Configs/check_login.php';?>
      ...
      <form class="form-signin" method="post">
        ...
        <input name="eaddress" type="email" class="input-block-level" placeholder="myEmail@gmail.com" maxlength="20">
        <input name="haddress" type="text" class="input-block-level" placeholder="Addresse" maxlength="50">
